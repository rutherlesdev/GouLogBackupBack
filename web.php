...
Route::get('/auth/admin', 'PageController@admin')->name('get.admin');
Route::post('/auth/admin', 'Auth\LoginController@admin')->name('post.admin');
...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/cobranca', 'AdminController@cobranca')->name('admin.cobranca');
     Route::get('/dinheiro', 'AdminController@dinheiro')->name('admin.dinheiro');
