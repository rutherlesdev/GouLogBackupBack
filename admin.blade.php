        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                  ...
                  <i class=" icon-2x text-slate-300   p-3 mb-3 mt-1">    <img src="https://appchegou.com/assets/img/logos/logo.png?v=1590471321tbwZK" alt="HTML5 Icon" style="width:165px;height:50px;"></i>
                ...
                <div class="content d-flex justify-content-center align-items-center mt-3">
                    <button class="btn btn-lg btn-registerBtn mr-2 regButtonDelivery" type="button">Cadastro entregador</button>
                    <button class="btn btn-lg btn-registerBtn regButtonResOwn" type="button">Cadastro restaurante</button>
                </div>
            </div>
        </div>
    </form>
        ...
        <div class="card mb-0">
            <div class="card-body">
                <div class="text-center mb-3">
                    ...
                    <h5 class="mb-0">Registro para <span id="regFor">Restaurante</span></h5>
                ...
                <div class="form-group form-group-feedback form-group-feedback-left">
                    <input type="Telefone" class="form-control" placeholder="Telefone" name="phone" min="8" required="required">
                    <div class="form-control-feedback">
                        <i class="icon-mobile text-muted"></i>
                    </div>
                </div>
                <div class="form-group form-group-feedback form-group-feedback-left">
                    <input type="Senha" class="form-control" placeholder="Senha" name="password" required="required">
                    <div class="form-control-feedback">
                        <i class="icon-lock2 text-muted"></i>
                    </div>
                </div>
                {!! captcha_img('flat') !!}
                <div class="form-group form-group-feedback form-group-feedback-left">
                <input type="text" class="form-control" placeholder="Entre com o Captcha" name="captcha" required="required">
                    <div class="form-control-feedback">
                ...
                @csrf
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block" style="height: 2.8rem; font-size: 1rem;">Registre-se <i
                        class="icon-circle-right2 ml-2"></i></button>
                </div>

                <div class="content-divider text-muted form-group"><span> OR </span></div>
                <div class="content d-flex justify-content-center align-items-center mt-3">
                    <button class="btn btn-lg btn-registerBtn mr-2 regButtonDelivery" type="button">Registre-se para Entregador</button>
                    <button class="btn btn-lg btn-registerBtn regButtonResOwn" type="button">Registre sua loja</button>
                </div>
